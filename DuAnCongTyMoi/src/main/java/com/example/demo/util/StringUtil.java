...
public class StringUtil {
     ...
     * @param highlight1 the highlight 1
     * @param highlight2 the highlight 2
     * @return the string
     */
     ...
     *
     * @param maps        the maps
     * @param mapSparator the map sparator
     * @param sparator    the sparator
     * @return the string
     */
    public static String join(Map<?, ?> maps, String mapSparator, String sparator) {
        List<String> mapStr = new ArrayList<>();

        for (Map.Entry<?, ?> entry : maps.entrySet()) {
            mapStr.add(GetterUtil.getString(entry.getKey()) + mapSparator + GetterUtil.getString(entry.getValue()));
        }

        return join(mapStr, sparator);
    }
     ...
     *
     * @param s       the s
     * @param oldSubs the old subs
     * @param newSubs the new subs
     * @return the string
     */
